...
namespace Extensions
{
	public static class CollectionExtensions 
	{
		...
		public static string ToInitializerString<T> (this T[] array)
		{
			string output = "new " + typeof(T).Name + "[" + array.Length + "] { ";
			for (int i = 0; i < array.Length; i ++)
			{
				T value = array[i];
				output += value + ", ";
		...
		public static T[] GetCopy<T> (this T[] array, int lastIndex)
		{
			T[] output = new T[lastIndex];
