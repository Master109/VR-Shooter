...
namespace Extensions
{
	public static class VectorExtensions
	{
		...
		public static bool IsInsideBounds (this Vector3 v, Vector3 boundsExtents, bool canBeEqualTo)
		{
			if (canBeEqualTo)
		...
		public static string ToInitializerString (this Vector2Int v)
		{
			return "new Vector2Int(" + v.x + ", " + v.y + ")";
		}

		public static string ToInitializerString (this Vector3Int v)
		{
			return "new Vector3Int(" + v.x + ", " + v.y + ", " + v.z + ")";
		}

		public static string ToInitializerString (this Vector2 v)
		{
			return "new Vector2(" + v.x + ", " + v.y + ")";
		}

		public static string ToInitializerString (this Vector3 v)
		{
			return "new Vector3(" + v.x + ", " + v.y + ", " + v.z + ")";
		}
    }
